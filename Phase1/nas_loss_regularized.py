...
def create_parser():
    ...
    parser.add_argument('--logs_file', type=str, default='nas_loss_regularized_effnet_5000_init.log',
...
if __name__ == "__main__":
    ...
    algo.initialize(fitness_function=fitness_function_effnet, init_size=1000)
    ...
    for i in range(0, 6):
        algo.evolve(max_iter=500, fitness_function=fitness_function_effnet)
        pickle.dump(algo, open(args.save_dir + "/" + args.save_file + "_effnet{}".format(i), "wb"))
